...
void loop() 
{
  ...
  while( 1 )
  {
    ...
    result[counter] = ts_inp( template_prime );
    if ( result[counter].tuple_fields[1].data.int_field != 0 )  //Add better checking for valid tuple (using inp operation result - add in server)
    {
    ...
    result[counter] = ts_inp( template_not_prime );
    if ( result[counter].tuple_fields[1].data.int_field != 0 )  //Add better checking for valid tuple (using inp operation result - add in server)
    {
